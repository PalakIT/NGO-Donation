...
<section>
 <div class="containers">
         <div class="section-card">
             ...
             <div class="mission">
                 <p>We are dedicated to empowering communities through sustainable development, education, and healthcare initiatives. Our mission is to create lasting change by addressing the root causes of poverty and inequality.</p>
                 <p>Through collaborative partnerships and innovative solutions, we strive to build a more just and equitable world where everyone has the opportunity to thrive.</p>
         ...
         <div class="section-card">
             ...
             <div class="mission">
                 <p>We envision a world where all communities have access to essential resources, quality education, and adequate healthcare, enabling them to build sustainable futures.</p>
                 <p>We aspire to be a catalyst for positive change, inspiring individuals and organizations to join us in creating a global movement of compassion and action.</p>
                 <a href="donate.jsp" class="cta-button">Donate Now</a>
             </div>
         </div>
 </div>
